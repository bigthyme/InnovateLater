...
! function () {
    var t, e, r, n, i, o, s, a, u, l, h, c, p, d, f, _, y, g, m, v, w, b, S, D, E, A, x, O, U, T, C, k, I, R, P, L, N, F, z, j, B, M, X, H, V, q, J, G, W, K, $, Z, Q, Y, te, ee, re, ne, ie, oe, se = {}.hasOwnProperty,
        ae = [].indexOf || function (t) {
    ...
    if (x = function () {
        ...
        function t() {}
        return t
    }(), u = "1.0.0", "undefined" != typeof global && "undefined" != typeof module && "exports" in module) f = global, _ = module.require.bind(module), module.exports = x;
    else if ("undefined" != typeof window && "undefined" != typeof navigator) f = window, _ = null, window.Dropbox && function () {
        var t, e, r, n;
        r = window.Dropbox, n = [];
        ...
        f = self, _ = self.importScripts.bind(self), self.Dropbox = x
    } if (x.Env = function () {
        function t() {}
        return t.global = f, t.require = _, t
        ...
        return t.prototype.addListener = function (t) {
            ...
            return ae.call(this._listeners, t) < 0 && this._listeners.push(t), this
        ...
        if ("undefined" != typeof chrome && (chrome.extension || chrome.app && chrome.app.runtime)) return t.authDriver(new x.AuthDriver.Chrome), void 0;
        if ("undefined" != typeof window) {
            if (window.cordova) return t.authDriver(new x.AuthDriver.Cordova), void 0;
        ...
        return t.prototype.authType = function () {
            ...
            var e, r;
            return e = t || x.AuthDriver.BrowserBase.currentLocation(), r = this.stateRe.exec(e), r ? decodeURIComponent(r[2]) : null
        ...
        return ue(e, t), e.prototype.baseUrl = function (t) {
            var e, r;
        ...
        return ue(e, t), e.prototype.url = function () {
            return this.receiverUrl
            ...
            }, window.addEventListener("message", r, !1), x.AuthDriver.Popup.onMessage.addListener(r)
        ...
        }, e.onMessage = new x.Util.EventSource, e
        ...
        return ue(e, t), e.prototype.onMessage = c, e.prototype.sendMessage = p, e.prototype.expandUrl = function (t) {
            ...
            return n = function (o, s) {
                var a;
                if ((!s || !s.tab || s.tab.url.substring(0, i.receiverUrl.length) === i.receiverUrl) && o.dropbox_oauth_receiver_href) return a = o.dropbox_oauth_receiver_href, i.locationStateParam(a) === t ? (t = !1, e.handle && i.closeWindow(e.handle), i.onMessage.removeListener(n), r(x.Util.Oauth.queryParamsFromUrl(a))) : void 0
            ...
            return window.addEventListener("load", function () {
                var t, e;
                return t = new x.AuthDriver.Chrome, e = window.location.href, window.location.hash = "", t.sendMessage({
            ...
            return o = window.open(t, "_blank", "location=yes,closebuttoncaption=Cancel"), a = !1, i = /^[^/]*\/\/[^/]*\//.exec(t)[0], u = !1, s = function (t) {
                if (t.url && l.locationStateParam(t.url) === e) {
                    ...
                    return o.removeEventListener("loadstart", s), o.removeEventListener("loaderror", s), o.removeEventListener("loadstop", s), o.removeEventListener("exit", s), u = !0, window.setTimeout(function () {
                        return o.close()
                    }, 10), n(x.Util.Oauth.queryParamsFromUrl(t.url)), void 0
                }
                if ("exit" === t.type) {
                    if (u) return;
        ...
        function t(t) {
            ...
            })) : this._tlsOptions = null, this._fs = x.Env.require("fs"), this._http = x.Env.require("http"), this._https = x.Env.require("https"), this._open = x.Env.require("open"), this._callbacks = {}, this._nodeUrl = x.Env.require("url"), this.createApp()
        }
        return t.prototype.authType = function () {
            return "code"
        }, t.prototype.url = function () {
        ...
        function t(t) {
            var e = this;
            this.serverRoot = t.server || this.defaultServerRoot(), this.maxApiServer = "maxApiServer" in t ? t.maxApiServer : this.defaultMaxApiServer(), this.authServer = t.authServer || this.defaultAuthServer(), this.fileServer = t.fileServer || this.defaultFileServer(), this.downloadServer = t.downloadServer || this.defaultDownloadServer(), this.onXhr = new x.Util.EventSource({
                cancelable: !0
            }), this.onError = new x.Util.EventSource, this.onAuthStepChange = new x.Util.EventSource, this.xhrOnErrorHandler = function (t, r) {
                return e.handleXhrError(t, r)
            }, this.oauth = new x.Util.Oauth(t), this.uid = t.uid || null, this.authStep = this.oauth.step(), this.driver = null, this.filter = null, this.authError = null, this._credentials = null, this._datastoreManager = null, this.setupUrls()
        }
        return t.prototype.onXhr = null, t.prototype.onError = null, t.prototype.onAuthStepChange = null, t.prototype.authDriver = function (t) {
            ...
            return o = function () {
                return a.authStep = a.oauth.step(), a.authStep === d.ERROR && (a.authError = a.oauth.error()), a._credentials = null, a.onAuthStepChange.dispatch(a), s()
            }, i = function () {
                return a.authStep = d.ERROR, a._credentials = null, a.onAuthStepChange.dispatch(a), s()
            }, n = null, s = function () {
                var t;
                ...
                case d.RESET:
                    return r ? (a.driver.getStateParam && a.driver.getStateParam(function (t) {
                        return a.client.authStep === d.RESET && a.oauth.setAuthStateParam(t), o()
                ...
                case d.DONE:
                    ...
                    break;
                case d.SIGNED_OUT:
                    return a.authStep = d.RESET, a.reset(), s();
                case d.ERROR:
                    e && e(a.authError, a)
                }
            }, s(), this
            ...
            return n = new x.Util.Xhr("POST", this.urls.signOut), n.signWithOauth(this.oauth), this.dispatchXhr(n, function (t) {
                if (t)
                    if (t.status === x.ApiError.INVALID_TOKEN) t = null;
                    else if (r) return e && e(t), void 0;
                return i.authStep = d.RESET, i.reset(), i.authStep = d.SIGNED_OUT, i.onAuthStepChange.dispatch(i), i.driver && i.driver.onAuthStepChange ? i.driver.onAuthStepChange(i, function () {
            ...
            var r, n;
            return e || "function" != typeof t || (e = t, t = null), r = !1, t && t.httpCache && (r = !0), n = new x.Util.Xhr("GET", this.urls.accountInfo), n.signWithOauth(this.oauth, r), this.dispatchXhr(n, function (t, r) {
            ...
            return r || "function" != typeof e || (r = e, e = null), i = {}, u = "text", s = null, n = !1, e && (e.versionTag ? i.rev = e.versionTag : e.rev && (i.rev = e.rev), e.arrayBuffer ? u = "arraybuffer" : e.blob ? u = "blob" : e.buffer ? u = "buffer" : e.binary && (u = "b"), e.length ? (null != e.start ? (a = e.start, o = e.start + e.length - 1) : (a = "", o = e.length), s = "bytes=" + a + "-" + o) : null != e.start && (s = "bytes=" + e.start + "-"), e.httpCache && (n = !0)), l = new x.Util.Xhr("GET", "" + this.urls.getFile + "/" + this.urlEncodePath(t)), l.setParams(i).signWithOauth(this.oauth, n), l.setResponseType(u), s && (s && l.setHeader("Range", s), l.reportResponseHeaders()), this.dispatchXhr(l, function (t, e, n, i) {
                var o;
                return o = i ? x.Http.RangeInfo.parse(i["content-range"]) : null, r(t, e, x.File.Stat.parse(n), o)
            })
        }, t.prototype.writeFile = function (t, e, r, n) {
            var i;
            return n || "function" != typeof r || (n = r, r = null), i = x.Util.Xhr.canSendForms && "object" == typeof e, i ? this.writeFileUsingForm(t, e, r, n) : this.writeFileUsingPut(t, e, r, n)
            ...
            var i, o;
            return i = {}, r && (r.noOverwrite && (i.overwrite = "false"), r.lastVersionTag ? i.parent_rev = r.lastVersionTag : (r.parentRev || r.parent_rev) && (i.parent_rev = r.parentRev || r.parent_rev)), o = new x.Util.Xhr("POST", "" + this.urls.putFile + "/" + this.urlEncodePath(t)), o.setBody(e).setParams(i).signWithOauth(this.oauth), this.dispatchXhr(o, function (t, e) {
                return n ? n(t, x.File.Stat.parse(e)) : void 0
            })
            ...
            return e ? (n = {
                ...
                offset: 0
            }, i = new x.Util.Xhr("POST", this.urls.chunkedUpload), i.setBody(t).setParams(n).signWithOauth(this.oauth), this.dispatchXhr(i, function (t, e) {
            ...
            return n || "function" != typeof r || (n = r, r = null), i = {
                upload_id: e.tag
            }, r && (r.lastVersionTag ? i.parent_rev = r.lastVersionTag : (r.parentRev || r.parent_rev) && (i.parent_rev = r.parentRev || r.parent_rev), r.noOverwrite && (i.overwrite = "false")), o = new x.Util.Xhr("POST", "" + this.urls.commitChunkedUpload + "/" + this.urlEncodePath(t)), o.setParams(i).signWithOauth(this.oauth), this.dispatchXhr(o, function (t, e) {
                return n ? n(t, x.File.Stat.parse(e)) : void 0
            })
        }, t.prototype.stat = function (t, e, r) {
            var n, i, o;
            return r || "function" != typeof e || (r = e, e = null), i = {}, n = !1, e && (e.versionTag ? i.rev = e.versionTag : e.rev && (i.rev = e.rev), e.contentHash ? i.hash = e.contentHash : e.hash && (i.hash = e.hash), (e.removed || e.deleted) && (i.include_deleted = "true"), e.readDir && (i.list = "true", e.readDir !== !0 && (i.file_limit = e.readDir.toString())), e.cacheHash && (i.hash = e.cacheHash), e.httpCache && (n = !0)), i.include_deleted || (i.include_deleted = "false"), i.list || (i.list = "false"), o = new x.Util.Xhr("GET", "" + this.urls.metadata + "/" + this.urlEncodePath(t)), o.setParams(i).signWithOauth(this.oauth, n), this.dispatchXhr(o, function (t, e) {
                var n, i, o;
                return o = x.File.Stat.parse(e), n = (null != e ? e.contents : void 0) ? function () {
                    var t, r, n, o;
                    for (n = e.contents, o = [], t = 0, r = n.length; r > t; t++) i = n[t], o.push(x.File.Stat.parse(i));
                    return o
                }() : void 0, r(t, o, n)
            })
            ...
            return r || "function" != typeof e || (r = e, e = null), i = e && (e["long"] || e.longUrl || e.downloadHack) ? {
                short_url: "false"
            } : {}, t = this.urlEncodePath(t), o = "" + this.urls.shares + "/" + t, n = !1, s = !1, e && (e.downloadHack ? (n = !0, s = !0) : e.download && (n = !0, o = "" + this.urls.media + "/" + t)), a = new x.Util.Xhr("POST", o).setParams(i).signWithOauth(this.oauth), this.dispatchXhr(a, function (t, e) {
                return s && (null != e ? e.url : void 0) && (e.url = e.url.replace(u.authServer, u.downloadServer)), r(t, x.File.ShareUrl.parse(e, n))
            })
        }, t.prototype.history = function (t, e, r) {
            var n, i, o;
            return r || "function" != typeof e || (r = e, e = null), i = {}, n = !1, e && (null != e.limit && (i.rev_limit = e.limit), e.httpCache && (n = !0)), o = new x.Util.Xhr("GET", "" + this.urls.revisions + "/" + this.urlEncodePath(t)), o.setParams(i).signWithOauth(this.oauth, n), this.dispatchXhr(o, function (t, e) {
                var n, i;
                return i = e ? function () {
                    var t, r, i;
                    for (i = [], t = 0, r = e.length; r > t; t++) n = e[t], i.push(x.File.Stat.parse(n));
                    return i
                }() : void 0, r(t, i)
            })
            ...
            var r, n;
            return r = {}, e && (e.format ? r.format = e.format : e.png && (r.format = "png"), e.size && (r.size = e.size)), n = new x.Util.Xhr("GET", "" + this.urls.thumbnails + "/" + this.urlEncodePath(t)), n.setParams(r).signWithOauth(this.oauth)
        }, t.prototype.revertFile = function (t, e, r) {
            var n;
            return n = new x.Util.Xhr("POST", "" + this.urls.restore + "/" + this.urlEncodePath(t)), n.setParams({
                rev: e
            ...
            return n || "function" != typeof r || (n = r, r = null), o = {
                query: e
            }, i = !1, r && (null != r.limit && (o.file_limit = r.limit), (r.removed || r.deleted) && (o.include_deleted = !0), r.httpCache && (i = !0)), s = new x.Util.Xhr("GET", "" + this.urls.search + "/" + this.urlEncodePath(t)), s.setParams(o).signWithOauth(this.oauth, i), this.dispatchXhr(s, function (t, e) {
                var r, i;
                return i = e ? function () {
                    var t, n, i;
                    for (i = [], t = 0, n = e.length; n > t; t++) r = e[t], i.push(x.File.Stat.parse(r));
                    return i
                }() : void 0, n(t, i)
            })
            ...
            var r;
            return r = new x.Util.Xhr("GET", "" + this.urls.copyRef + "/" + this.urlEncodePath(t)), r.signWithOauth(this.oauth), this.dispatchXhr(r, function (t, r) {
            ...
            return e || "function" != typeof t || (e = t, t = null), r = t ? t.cursorTag ? {
                ...
                cursor: t
            } : {}, n = new x.Util.Xhr("POST", this.urls.delta), n.setParams(r).signWithOauth(this.oauth), this.dispatchXhr(n, function (t, r) {
            ...
            var r;
            return r = new x.Util.Xhr("POST", this.urls.fileopsCreateFolder), r.setParams({
                root: "auto",
            ...
            var r;
            return r = new x.Util.Xhr("POST", this.urls.fileopsDelete), r.setParams({
                root: "auto",
                path: this.normalizePath(t)
            }).signWithOauth(this.oauth), this.dispatchXhr(r, function (t, r) {
                return e ? e(t, x.File.Stat.parse(r)) : void 0
            ...
            }, t instanceof x.File.CopyReference ? i.from_copy_ref = t.tag : i.from_path = this.normalizePath(t), o = new x.Util.Xhr("POST", this.urls.fileopsCopy), o.setParams(i).signWithOauth(this.oauth), this.dispatchXhr(o, function (t, e) {
                return r ? r(t, x.File.Stat.parse(e)) : void 0
            })
        }, t.prototype.move = function (t, e, r) {
            var n, i;
            return r || "function" != typeof n || (r = n, n = null), i = new x.Util.Xhr("POST", this.urls.fileopsMove), i.setParams({
                root: "auto",
            ...
            var r;
            return e || "function" != typeof t || (e = t, t = this.oauth.credentials().key), r = new x.Util.Xhr("GET", this.urls.appsInfo), r.setParams({
                app_key: t
            ...
            var n;
            return "object" == typeof t && "uid" in t && (t = t.uid), r || "function" != typeof e ? "object" == typeof e && "key" in e && (e = e.key) : (r = e, e = this.oauth.credentials().key), n = new x.Util.Xhr("GET", this.urls.appsCheckDeveloper), n.setParams({
                app_key: e,
                uid: t
            ...
            var n;
            return r || "function" != typeof e ? "object" == typeof e && "key" in e && (e = e.key) : (r = e, e = this.oauth.credentials().key), n = new x.Util.Xhr("GET", this.urls.appsCheckRedirectUri), n.setParams({
                app_key: e,
                redirect_uri: t
            }), this.dispatchXhr(n, function (t, e) {
            ...
            return this.apiServer = this.chooseApiServer(), this.urls = {
            ...
            var t, e;
            return e = Math.floor(Math.random() * (this.maxApiServer + 1)), t = 0 === e ? "" : e.toString(), this.serverRoot.replace("$", t)
            ...
            var t;
            return t = this.oauth.authorizeUrlParams(this.driver.authType(), this.driver.url()), this.urls.authorize + "?" + x.Util.Xhr.urlEncode(t)
        }, t.prototype.getAccessToken = function (t) {
            var e, r;
            return e = this.oauth.accessTokenParams(this.driver.url()), r = new x.Util.Xhr("POST", this.urls.token).setParams(e).addOauthParams(this.oauth), this.dispatchXhr(r, function (e, r) {
                return e && e.status === x.ApiError.INVALID_PARAM && e.response && e.response.error && (e = new x.AuthError(e.response)), t(e, r)
            })
        ...
        function t(t, e) {
            ...
            this._datastore_manager = t, this._managed_datastore = e, this._dsid = this._managed_datastore.get_dsid(), this._handle = this._managed_datastore.get_handle(), this._record_cache = new G(this), this._last_used_timestamp = 0, this.recordsChanged = new x.Util.EventSource, this.syncStatusChanged = new x.Util.EventSource, this._timeoutWrapper = function (t) {
                return t
            }, this._evt_mgr = new O, this._evt_mgr.register(this._managed_datastore.syncStateChanged, function () {
                return r._syncSoon(), r.syncStatusChanged.dispatch(null)
            }), this._syncPending = !1, this._closed = !1, this._metadata_table = new x.Datastore.Table(this, ":info"), this._metadata_table.setResolutionRule("mtime", "max")
        }
        return t.prototype.recordsChanged = null, t.prototype.syncStatusChanged = null, t.int64 = function (t) {
            var e, r;
            ...
            if (te.is_string(t)) {
                ...
                return r = new Number(parseInt(t, 10)), r[ie.INT64_TAG] = t, ie.validateInt64(r)
            }
            ...
            return r = new Number(t), r[ie.INT64_TAG] = e, ie.validateInt64(r)
            ...
            var e;
            return e = new RegExp(te.DS_ID_REGEX), te.is_string(t) && e.test(t)
            ...
            for (s in n)
                for (r = n[s], a = 0, u = r.length; u > a; a++) e = r[a], ne(s === e._tid, "tid mismatch"), t = !0, o = e._rid, this._managed_datastore.query(s, o) || (e._deleted = !0, this._record_cache.remove(s, o));
            return t && this.recordsChanged.dispatch(new K(n, !1)), void 0
            ...
            return t.length > 0 && (this.recordsChanged.dispatch(K._fromRecordList(t, !0)), this._syncSoon()), void 0
    ...
    }(), ie = x.Datastore.impl = {}, te = x.Datastore.impl.T = {}, te.identity = function (t) {
        return t
        ...
        if (t) return r;
        throw te.fail(e, r, n, i, o), new Error("unreachable")
        ...
        var o, s;
        throw s = null != r ? null != n ? null != i ? "Wanted " + te.str(n) + ", but " + te.str(r) + " in " + te.str(i) + " " + te.str(t) : "Wanted " + te.str(n) + ", but " + te.str(r) + " " + te.str(t) : "" + te.str(r) + " " + te.str(t) : null != n ? null != i ? "Wanted " + te.str(n) + ", but in " + te.str(i) + " " + te.str(t) : "Wanted " + te.str(n) + ", but " + te.str(t) : "" + te.str(t), o = new Error("" + s + ": " + te.safe_to_string(e)), console.error(o), o
    }, te.any = function (t) {
        return t
    }, te.defined = function (t, e, r, n) {
        return null == r && (r = "defined"), te.check("undefined" != typeof t, "is undefined", t, e, r, n), t
    }, te.nonnull = function (t, e, r, n) {
        return null == r && (r = "nonnull"), te.defined(t, e, r, n), te.check(null != t, "is null", t, e, r, n), t
    }, te.member = function (t) {
        var e, r;
        return r = "value in " + JSON.stringify(t), e = "not in " + JSON.stringify(t),
        function (n, i, o, s) {
            return null == o && (o = r), te.check(ae.call(t, n) >= 0, e, n, i, o, s)
        }
    }, te.object = function (t, e, r, n) {
        return null == r && (r = "object"), te.nonnull(t, e, r, n), te.check("object" == typeof t, "not an object", t, e, r, n), t
    }, te.bool = function (t, e, r, n) {
        return null == r && (r = "bool"), te.nonnull(t, e, r, n), te.check(t === !0 || t === !1, "is not bool", t, e, r, n), t
    }, te.string = function (t, e, r, n) {
        return null == r && (r = "string"), te.nonnull(t, e, r, n), te.check(te.is_string(t), "is not a string", t, e, r, n), t
    }, te.num = function (t, e, r, n) {
        return null == r && (r = "num"), te.nonnull(t, e, r, n), te.check("number" == typeof t, "is not numeric", t, e, r, n), t
    }, te.int = function (t, e, r, n) {
        return null == r && (r = "int"), te.num(t, e, r, n), te.check(0 === t % 1, "is not an integer", t, e, r, n), t
    }, te.uint = function (t, e, r, n) {
        return null == r && (r = "uint"), te.int(t, e, r, n), te.check(t >= 0, "is negative", t, e, r, n), t
    }, te.nullable = function (t) {
        var e, r;
        return r = "nullable(" + t + ")", e = function (e, n, i, o) {
            return null == i && (i = function () {
                return r
            }), te.defined(e, n, i, o), null != e && te.get_T_fn(t)(e, n, i, o), e
        }, e.toString = function () {
            return r
        }, e.coerce = function (e) {
        ...
        return null == r && (r = "array"), te.nonnull(t, e, r, n), te.check(te.is_array(t), "is not an array", t, e, r, n), t
    }, te.arrayOf = function (t) {
        var e, r;
        return r = "arrayOf(" + t + ")", e = function (e, n, i, o) {
            var s, a, u, l, h;
            for (null == i && (i = r), te.array(e, n, i, o), u = l = 0, h = e.length; h > l; u = ++l) s = e[u], a = function () {
            ...
            var n, i, o, s;
            for (te.array(e, null, r), s = [], i = 0, o = e.length; o > i; i++) n = e[i], s.push(te.get_coerce_fn(t)(n));
            return s
        }, e.fromJSON = function (n) {
            var i, o, s, a;
            if (te.array(n, "fromJSON input", r), null != t.fromJSON) {
                for (a = [], o = 0, s = n.length; s > o; o++) i = n[o], a.push(t.fromJSON(i));
                return a
            }
            return e.coerce(n)
        }, e
        ...
        return t instanceof e || (null == n && (n = e.name), te.check(!1, "got instance of " + (null != t ? null != (o = t.constructor) ? o.name : void 0 : void 0), t, r, n, i)), t
        ...
        var e;
        return te.string(t), te.check(/^[^].*[$]$/.test(t), "does not start with ^ and end with $", t), e = "does not match regex " + t,
        function (r, n, i, o) {
            return te.string(r, n, i, o), te.check(new RegExp(t).test(r), e, r, n, i, o), r
        }
        ...
        var i, o;
        null == r && (r = "simple map"), te.object(t, e, r, n);
        for (i in t) o = t[i], te.check(Object.prototype.hasOwnProperty.call(t, i), function () {
            return "property " + i + " is inherited"
        }, t, e, r, t);
        return t
    }, te.simple_typed_map = function (t, e, r) {
        var n, i, o;
        return n = te.get_coerce_fn(e), i = te.get_coerce_fn(r), o = function (n, i, o, s) {
            var a, u;
            null == o && (o = t), te.simple_map(n, i, o, s);
            for (a in n) u = n[a], te.get_T_fn(e)(a, "property", null, n), te.get_T_fn(r)(u, function () {
                return "value of property " + a
            }, null, n);
            return n
        }, o.coerce = function (e) {
            var r, o, s;
            te.simple_map(e, null, t), o = {};
            for (r in e) s = e[r], o[n(r)] = i(s);
            return o
        }, o.fromJSON = function (e) {
            var i, o, s;
            te.simple_map(e, null, t), o = {};
            for (i in e) s = e[i], o[n(i)] = null != r.fromJSON ? r.fromJSON(s) : s;
            return o
        }, o
    }, te.DS_ID_REGEX = "^[-_a-z0-9]([-_a-z0-9.]{0,30}[-_a-z0-9])?$|^[.][-_a-zA-Z0-9]{1,100}$", te.dsid = function (t, e, r, n) {
        return null == r && (r = "dsid"), te.string_matching(te.DS_ID_REGEX)(t, e, r, n), t
    }, te.SS_ID_REGEX = "^[-:._+/=a-zA-Z0-9][-._+/=a-zA-Z0-9]{0,31}$", te.tid = function (t, e, r, n) {
        return null == r && (r = "tid"), te.string_matching(te.SS_ID_REGEX)(t, e, r, n), t
    }, te.rowid = function (t, e, r, n) {
        return null == r && (r = "rowid"), te.string_matching(te.SS_ID_REGEX)(t, e, r, n), t
    }, te.field_name = function (t, e, r, n) {
        return null == r && (r = "field name"), te.string_matching(te.SS_ID_REGEX)(t, e, r, n), t
    }, function () {
        var t, e, r;
        r = [];
        for (t in te) e = te[t], te.hasOwnProperty(t) ? r.push(function (t) {
            return e.toString = function () {
                return "T." + t
            }
        }(t)) : r.push(void 0);
        return r
    }(), ie.struct = oe = {}, oe.define = function (t, e) {
        var r, n, i, o, s, a, u, l, h, c, p, d, f, _, y, g;
        for (te.string(t, "struct name"), te.array(e, "fields"), _ = [], f = {}, s = y = 0, g = e.length; g > y; s = ++y) {
            i = e[s], te.array(i, "field", "field descriptor", e), te.check(2 <= i.length && i.length <= 3, "does not have length 2 or 3", i, "field descriptor"), c = te.string(i[0], "field name", "field descriptor", e), d = te.nonnull(i[1], "field type", "field descriptor", e), p = i.length <= 2 ? {} : te.nonnull(i[2], "map of field options", "field descriptor", e);
            for (l in p) "init" !== l && "initFn" !== l && te.fail("unknown option " + l, p, "field options", "field descrptor", e);
            ae.call(p, "init") >= 0 && ae.call(p, "initFn") >= 0 && te.fail("both 'init' and 'initFn' specified", p, "field options", "field descriptor", e), u = "initFn" in p ? p.initFn : "init" in p ? (a = p.init, function (t) {
                return function () {
                    return t
                }
            }(a)) : null, r = {
                ...
                type: d,
                initFn: u
            }, o = "undefined" != typeof Z && null !== Z ? new Z(r) : r, _.push(o), f[c] = o
        }
        return h = "initializer for " + t + " (fields " + function () {
            var t, e, r;
            for (r = [], t = 0, e = _.length; e > t; t++) i = _[t], r.push(i.name);
            return r
        }().join(", ") + ")", n = function (t) {
            var e, r, i;
            te.defined(t, "x", "initializer");
            for (c in t) e = t[c], t.hasOwnProperty(c) && te.check(null != f[c], function () {
                return "has an unexpected field " + c
            }, t, "initializer");
            for (r = 0, i = _.length; i > r; r++) o = _[r], t[o.name] && !t.hasOwnProperty(o.name) && te.fail("Has an indirect property " + o.name, t, "initializer"), t.hasOwnProperty(o.name) ? (e = t[o.name], this[o.name] = te.get_coerce_fn(o.type)(e)) : null != o.initFn ? this[o.name] = o.initFn() : te.fail("lacks the field " + o.name, t, "initializer");
            ...
            }, e, r, i, s), u = 0, l = _.length; l > u; u++) o = _[u], te.check(e.hasOwnProperty(o.name), function () {
                return "lacks the field " + o.name
            }, e, r, i, s), te.get_T_fn(o.type)(e[o.name], o.name, i, s);
            for (c in e) a = e[c], e.hasOwnProperty(c) && te.check(null != f[c], "has an unexpected field", c, r, i, s);
            return e
        }, n.coerce = function (t) {
            return t instanceof n ? (n.Type(t), t) : new n(t)
        }, n.prototype.toString = function () {
            var t, e, r, n, i;
            for (e = this, t = [], n = 0, i = _.length; i > n; n++) o = _[n], r = e[o.name], t.push("" + o.name + ": " + (te.is_object(r) && te.is_function(r.toString) ? r.toString() : JSON.stringify(r)));
            return "{" + t.join(", ") + "}"
        }, n.prototype.toJSON = function () {
            var t, e, r, n;
            for (t = this, e = function () {
                return "" + t
            }, r = 0, n = _.length; n > r; r++) o = _[r], te.get_T_fn(o.type)(this[o.name], o.name, null, e);
            return this
        }, n.fromJSON = function (e) {
            var r, i, o;
            te.simple_map(e, "input"), i = [];
            for (l in e) o = e[l], null == f[l] && (i.push("" + l + ": " + JSON.stringify(o)), delete e[l]);
            i.length > 0 && console.info("Ignoring unknown fields while deserializing " + t + ": " + i.join(", ")), r = {};
            for (l in e) o = e[l], d = f[l].type, r[l] = null != d.fromJSON ? d.fromJSON(o) : o;
            return new n(r)
        }, n.toString = function () {
            return "struct " + t
        }, n
        ...
        if (te.is_array(t)) return function () {
            var r, n, i;
            for (i = [], r = 0, n = t.length; n > r; r++) e = t[r], i.push(oe.toJSO(e));
            return i
        }();
        n = {};
        for (r in t) i = t[r], t.hasOwnProperty(r) && (n[r] = oe.toJSO(i));
        return n
    }, oe.union_as_list = function (t, e) {
        var r, n, i, o, s, a, u, l, h, c, p;
        for (te.string(t, "union name"), te.array(e, "variants"), n = function () {
            throw new Error("Use " + t + ".from_array instead")
        }, l = {}, u = [], h = function (e, r, i) {
            var o;
            return o = oe.define("" + t + "." + e, i), o.prototype.tag = function () {
                return e
            }, o.prototype.toString = function () {
                return "" + t + "." + e + "(" + JSON.stringify(this) + ")"
            }, o.prototype.toJSON = function () {
                var t, n, i, o, s, a;
                for (t = [e], s = 0, a = r.length; a > s; s++) n = r[s], i = n[0], o = n[1], te.get_T_fn(o)(this[i], i), t.push(this[i]);
                return t
                ...
                for (l = "initializer for " + t, te.array(n, "initializer", l), te.check(n.length === r.length + 1, "does not have length " + (r.length + 1), n, "initializer", l), te.check(n[0] === e, "does not have tag " + e, n, "initializer", l), i = {
                    _tag: e
                }, a = h = 0, c = r.length; c > h; a = ++h) s = r[a], u = s[0], i[u] = n[a + 1];
                return new o(i)
        ...
        }, c = 0, p = e.length; p > c; c++) i = e[c], te.array(i, "variant", "variant descriptor", e), te.check(2 === i.length, "does not have length 2", i, "variant descriptor", e), a = te.string(i[0], "tag", "tag", e), o = te.array(i[1], "fields", "variant descriptor", e), s = o.slice(0), s.unshift(["_tag", te.member([a])]), h(a, o, s), u.push(a);
        return r = "initializer for " + t + " (variants " + u.join(", ") + ")", n.from_array = function (e) {
            var r, n;
            return n = "initializer for " + t, te.array(e, "initializer", n), te.check(e.length >= 1, "lacks a tag", e, "initializer", n), r = e[0], te.string(r, "tag", n, e), te.member(u)(r), l[r].from_array(e)
        }, n.fromJSON = function (e) {
            var r, n;
            return n = "initializer for " + t, te.array(e, "initializer", n), te.check(e.length >= 1, "lacks a tag", e, "initializer", n), r = e[0], te.string(r, "tag", n, e), te.member(u)(r), l[r].fromJSON(e)
        }, n.Type = function (e, r, n, i) {
            var o;
            return null == n && (n = "" + t + ".Type"), te.defined(e, r, n, i), te.defined(e.tag, "tag", n, i), o = e.tag(), te.string(o, "tag", "initializer", e), te.member(u)(o), l[o].Type(e, null, "object of type " + t), e
        }, n.coerce = function (t) {
            var e, r;
            for (r in l)
                if (e = l[r], t instanceof e) return e.Type(t), t;
        ...
        case "I":
        case "T":
            return r = null != (i = t.I) ? i : t.T, ie.is_valid_int64_string(r);
        default:
            return !1
        }
        ...
        if (te.is_array(t)) {
            for (r = 0, n = t.length; n > r; r++)
                if (e = t[r], !ie.is_atomic_field_value(e)) return !1;
            return !0
        }
        return !1
        ...
        return null == r && (r = "atomic field value"), te.check(ie.is_atomic_field_value(t), "is not an atomic field value", t, e, r, n), t
    }, ie.list_value = function (t, e, r, n) {
        return null == r && (r = "list value"), te.arrayOf(ie.atomic_field_value)(t, e, r, n), t
    }, ie.compound_field_value = function (t, e, r, n) {
        return null == r && (r = "field value"), te.is_array(t) ? ie.list_value(t, e, r, n) : ie.atomic_field_value(t, e, r, n)
    }, ie.FieldOp = T = oe.union_as_list("FieldOp", [
        ["P", [
            ["value", ie.compound_field_value]
        ]],
        ["D", []],
        ["LC", []],
        ["LP", [
            ["at", te.uint],
            ["value", ie.atomic_field_value]
        ]],
        ["LI", [
            ["before", te.uint],
            ["value", ie.atomic_field_value]
        ...
        ["handle", te.string],
        ["rev", te.uint]
    ]), E = oe.define("DeleteDatastoresResponse", []), q = oe.define("PutDeltasResponse", [
        ["rev", te.nullable(te.uint), {
            init: null
        }],
        ["conflict", te.nullable(te.string), {
            init: null
        }]
    ]), R = oe.define("GetDeltasResponse", [
        ["deltas", te.nullable(te.arrayOf(A)), {
            init: null
        }],
        ["notfound", te.nullable(te.string), {
            init: null
        }]
    ]), e = oe.define("AwaitResponseDeltas", [
        ["deltas", te.simple_typed_map("deltas map", te.string, R)]
    ]), ie.AwaitResponse = t = oe.define("AwaitResponse", [
        ["get_deltas", te.nullable(e), {
            init: null
        }],
        ["list_datastores", te.nullable(N), {
            init: null
        }]
    ]), h = function () {
        function t(t) {
        ...
        return n = 6e4, e = 0, t.prototype.run = function (t, e, r) {
            ...
            return s = null != (l = e.do_retry) ? l : function () {
                ...
                return o ? void 0 : t(function () {
                    var t, e, n;
                    return t = arguments[0], e = 2 <= arguments.length ? le.call(arguments, 1) : [], o ? void 0 : t && s(t) ? Date.now() > u ? (console.error("Giving up due to error", t), r(t)) : (n = c.backoff.get_backoff_millis(), console.warn("Retrying in " + n + " ms due to error", t), setTimeout(i, n)) : r.apply(null, [t].concat(le.call(e)))
                })
            }, i(),
            function () {
                return o = !0
        ...
        function t(t, e, r) {
            this.changes = t, this.undo_extras = e, this.finalized = null != r ? r : !1
        }
        var e;
        return e = function (t, e) {
            ...
            case "U":
                s = "U", i = {};
                for (o in e) a = e[o], i[o] = null == a ? ["D"] : ["P", a];
                break;
            case "D":
                s = "I", i = ie.clone(e);
                break;
            ...
            return ne(!this.finalized, "add_change: already finalized"), this.changes.push(t), this.undo_extras.push(e)
        }, t.prototype["package"] = function (t, e) {
            return ne(this.finalized, "package: not finalized"), new A({
        ...
        if (te.is_array(t)) {
            for (e = 20 * t.length, n = 0, i = t.length; i > n; n++) r = t[n], e += ie.value_size(r);
            return e
        }
        ...
        case "P":
            return i = r.value, n ? ie.value_size(i) - ie.value_size(n) : 100 + ie.value_size(i);
        case "D":
            return null != n ? -(100 + ie.value_size(n)) : 0;
        case "LC":
            return ne(null == n, "can't create list for field that already exists"), 100;
        case "LP":
            return ne(te.is_array(n), "LP on non-list"), ne(0 <= (o = r.at) && o < n.length, "bad index for LP"), ie.value_size(r.value) - ie.value_size(n[r.at]);
        case "LI":
            return null != n ? 20 + ie.value_size(r.value) : 120 + ie.value_size(r.value);
        case "LD":
            return ne(te.is_array(n), "LD on non-list"), ne(0 <= (s = r.at) && s < n.length, "bad index for LD"), -(20 + ie.value_size(n[r.at]));
        case "LM":
            return 0;
        default:
        ...
        return s = function () {
            ...
            case "I":
                o = 100, s = e.fields;
                for (r in s) u = s[r], o += 100 + ie.value_size(u);
                return o;
            case "U":
                i = t.get_record(e.tid, e.rowid), te.assert(null != i, function () {
                    return "record not found: " + JSON.stringify(e)
                }), a = 0, l = e.updates;
                for (r in l) n = l[r], a += ie.size_difference_for_field_op(i, r, n);
                return a;
            case "D":
        ...
        function t(t, e, r) {
            var n, i;
            this._tid = t, this._rid = e, null == r && (r = {}), this._fields = {}, this._size = 100;
            for (n in r) i = r[n], this._fields[n] = ie.clone(i), this._size += 100 + ie.value_size(i)
        }
        return t.prototype.get = function (t) {
            ...
            return null != e ? this._fields[t] = ie.clone(e) : delete this._fields[t], void 0
            ...
            case "D":
                ...
                break;
            case "LC":
                ne(null == r, "can't create list for field that already exists"), this._fields[t] = [];
                break;
            case "LP":
                ne(te.is_array(r), "LP on non-list"), ne(0 <= (i = e.at) && i < r.length, "bad index for LP"), r[e.at] = ie.clone(e.value);
                break;
            case "LI":
                null != r ? (ne(te.is_array(r), "LI on non-list"), ne(0 <= (o = e.before) && o <= r.length, "bad index for LI"), r.splice(e.before, 0, ie.clone(e.value))) : (ne(0 === e.before, "bad index for LI on nonexistent field"), this._fields[t] = [ie.clone(e.value)]);
                break;
            case "LD":
                ne(te.is_array(r), "LD on non-list"), ne(0 <= (s = e.at) && s < r.length, "bad index for LD"), r.splice(e.at, 1);
                break;
            case "LM":
                ne(te.is_array(r), "LM on non-list"), ne(0 <= (a = e.from) && a < r.length, "bad from index for LM"), ne(0 <= (u = e.to) && u < r.length, "bad to index for LM"), n = r[e.from], r.splice(e.from, 1), r.splice(e.to, 0, n);
                break;
            default:
        ...
        function t(t, e) {
            var r, n, i, o, s, a;
            this._tables = {}, this._size = 1e3;
            for (a in e) {
                i = e[a], s = this._get_table(a);
                for (o in i) r = i[o], n = new W(a, o, r), this._check_record_size(t, a, o, n._size), s.put(o, n), this._size += n._size
            }
            this._check_datastore_size(t, this._size)
        }
        return t.from_get_snapshot_resp = function (e) {
            var r, n, i, o, s, a;
            for (r = {}, a = e.rows, i = 0, o = a.length; o > i; i++) n = a[i], r[s = n.tid] || (r[s] = {}), r[n.tid][n.rowid] = n.data;
            return new t(!1, r)
        }, t.prototype._size_limit_exceeded = function (t, e) {
            var r;
            if (t) throw r = new Error(e), r.code = "SIZE_LIMIT_EXCEEDED", r;
            return console.warn(e), void 0
        }, t.prototype._check_record_size = function (t, e, r, n) {
            return n > M && this._size_limit_exceeded(t, "Record (" + e + ", " + r + ") too large: " + n + " bytes"), void 0
        }, t.prototype._check_datastore_size = function (t, e) {
            return e > j && this._size_limit_exceeded(t, "Datastore too large: " + e + " bytes"), void 0
            ...
            for (o in l)
                for (i = l[o], h = i.list_record_ids(), a = 0, u = h.length; u > a; a++) {
                    r = h[a], e = i.get(r), n += 100, c = e.get_all();
                    for (t in c) s = c[t], n += 100 + ie.value_size(s)
                }
            return n
            ...
            t = {}, s = this._tables;
            for (n in s)
                for (r = s[n], t[n] = {}, a = r.list_record_ids(), i = 0, o = a.length; o > i; i++) e = a[i], t[n][e] = ie.clone(r.get(e).get_all());
            return t
            ...
            case "I":
                this._check_record_size(t, e.tid, e.rowid, r), i = this._apply_insert(e);
                break;
            case "U":
                n = this.get_record(e.tid, e.rowid), te.assert(null != n, function () {
            ...
            return null == this._tables[t] && (this._tables[t] = new ee), this._tables[t]
        }, t.prototype._apply_insert = function (t) {
            var e, r;
            return r = this._get_table(t.tid), te.assert(!r.has(t.rowid), function () {
                return "_apply_insert: record already exists: " + JSON.stringify(t)
            }), e = new W(t.tid, t.rowid, t.fields), r.put(t.rowid, e), null
        }, t.prototype._apply_update = function (t, e) {
            var r, n, i, o, s, a, u;
            o = {};
            try {
                a = e.updates;
                for (n in a) i = a[n], s = ie.clone(null != (u = t.get(n)) ? u : null), t.apply_field_op(n, i), o[n] = s
            } catch (l) {
                r = l;
                for (n in o) s = o[n], t.put(!1, n, s);
                throw r
            }
            return o
        }, t.prototype._apply_delete = function (t) {
            var e, r, n;
            return n = this._get_table(t.tid), te.assert(n.has(t.rowid), function () {
                return "_apply_delete: record does not exist: " + JSON.stringify(t)
            }), r = n.get(t.rowid), e = ie.clone(r.get_all()), n.put(t.rowid, null), n.is_empty() && delete this._tables[t.tid], e
        }, t.prototype.query = function (t, e) {
            var r, n;
            return n = this._tables[t], null == n ? null : (r = n.get(e), null == r ? null : ie.clone(r.get_all()))
        ...
        function t(t, e, r, n, i, o) {
            this.dbid = t, this.handle = e, this.datastore_model = r, this.resolver = n, this.sync_state = i, this.flob_client = o, this.syncStateChanged = new x.Util.EventSource, this._deleted = !1, this._open = !0, this._commit_queue = new Q
        }
        return t.fresh_managed_datastore = function (e, r, n, i, o, s) {
            var a, u;
            return a = ie.randomWeb64String(10), u = new Y(a, null, i, [], []), new t(e, r, n, o, u, s)
            ...
            for (i = this.resolver.resolve(this.sync_state.unsynced_deltas, this.sync_state.server_deltas), n = i.rebased_deltas, t = i.affected_records, o = this.sync_state.unsynced_deltas.slice().reverse(), a = 0, c = o.length; c > a; a++)
                for (r = o[a], v = r.inverse_changes(), u = 0, p = v.length; p > u; u++) e = v[u], this.datastore_model.apply_change(!1, e);
            for (w = this.sync_state.server_deltas, l = 0, d = w.length; d > l; l++)
                for (r = w[l], b = r.changes, h = 0, f = b.length; f > h; h++) e = b[h], this.datastore_model.apply_change(!1, e);
            for (g = 0, _ = n.length; _ > g; g++)
                for (r = n[g], r.undo_extras = [], S = r.changes, m = 0, y = S.length; y > m; m++) e = S[m], s = this.datastore_model.apply_change(!1, e), r.undo_extras.push(s);
            ...
            var r;
            return r = this.datastore_model.apply_change(t, e), this.sync_state.add_unsynced_change(e, r), void 0
            ...
            var t;
            return this.has_unfinalized_changes && this.sync_state.finalize(), t = this._do_sync(), this._do_commit(), t
            ...
            return function () {
                var e, r, n, i;
                for (n = this.datastore_model.list_tables(), i = [], e = 0, r = n.length; r > e; e++) t = n[e], ":info" !== t && i.push(t);
                return i
            }.call(this)
        }, t.prototype.list_rows_for_table = function (t) {
        ...
        function t(t, e, r, n, i) {
            this.last_nonce = t, this.pending_delta = e, this.last_rev = r, this.unsynced_deltas = n, this.server_deltas = i, te.uint(this.last_rev, "last_rev")
        }
        return t.prototype.is_current = function () {
            ...
            var r;
            return r = this.unsynced_deltas.length, 0 === r || this.unsynced_deltas[r - 1].finalized ? this.unsynced_deltas.push(new z([t], [e])) : this.unsynced_deltas[r - 1].add_change(t, e)
        }, t.prototype._compact_deltas = function () {
            var t, e, r, n, i, o, s, a, u, l, h, c, p, d;
            if (n = this.unsynced_deltas.length, !(1 >= n)) {
                for (e = [], o = [], r = s = 0, c = n - 1; c >= 0 ? c > s : s > c; r = c >= 0 ? ++s : --s) {
                    for (p = this.unsynced_deltas[r].changes, a = 0, l = p.length; l > a; a++) t = p[a], e.push(t);
                    for (d = this.unsynced_deltas[r].undo_extras, u = 0, h = d.length; h > u; u++) i = d[u], o.push(i)
                }
                return this.unsynced_deltas = [new z(e, o, !0), this.unsynced_deltas[n - 1]]
            }
        }, t.prototype.get_next_commit = function () {
            var t, e, r;
            return ne(null == this.pending_delta, "delta pending"), t = this.unsynced_deltas.length, 0 === t ? null : (this._compact_deltas(), e = this.unsynced_deltas[0], e.finalized ? (r = this.last_nonce, this.pending_delta = e["package"](r, this.last_rev), this.pending_delta) : null)
            ...
            var t;
            if (this.has_unfinalized_changes()) return t = this.unsynced_deltas[this.unsynced_deltas.length - 1], ne(!t.finalized, "last delta already finalized"), t.finalized = !0
            ...
            return ne(this.is_ours(t), "not ours"), ne(null != this.pending_delta, "no pending delta"), ne(0 === this.server_deltas.length, "server deltas exist"), this.pending_delta = null, this.unsynced_deltas.shift(), this.last_rev++
        }, t.prototype.receive_server_delta = function (t) {
            var e, r;
            return r = this.server_deltas.length, e = r > 0 ? this.server_deltas[r - 1].rev + 1 : this.last_rev, ne(t.rev <= e, "was expecting rev " + e + ", but got " + t.rev + " instead!"), t.rev < e ? (console.warn("received old delta!"), !1) : this.is_ours(t) ? (this.ack(t), !1) : (this.server_deltas.push(t), this.pending_delta = null, !0)
        }, t
        ...
        return t.prototype.cancel = function () {
            ...
            return t = function () {
                var r;
                if (!e.cancelled) return r = ie.clone(e.update_manager._handle_version_map), e.cancel_fn = e.update_manager.flob_client.await(r, e.update_manager._last_dslist_token, function (n, i) {
                    var o, s, a, u, l, h, c, p, d, f;
                    if (e.cancel_fn = null, n) return 0 === n.status ? (console.log("await deltas failed (offline):", n), setTimeout(t, 1e4)) : n.status && 500 <= (p = n.status) && 599 >= p ? (console.log("server error:", n), setTimeout(t, 2e3)) : (console.error("Got error in longpoll:", n), setTimeout(t, 1e4));
                    if (null != i.get_deltas) {
                        d = i.get_deltas.deltas;
                        for (u in d)
                            if (s = d[u], null != s.notfound) e.update_manager._data_queue.push({
                                handle: u,
                                notfound: s.notfound
                            }), delete e.update_manager._handle_version_map[u];
                            else if (null != s.deltas) {
                            for (f = s.deltas, h = 0, c = f.length; c > h; h++) a = f[h], e.update_manager._data_queue.push({
                                handle: u,
                                delta: a
                            });
        ...
        return t.prototype.run = function (t) {
            ...
            var r, n;
            return ne(this._running, "update manager is not running"), r = this._handle_version_map[t], n = e, null != r && (n = Math.max(e, r)), this._handle_version_map[t] = n, this._do_longpoll()
        }, t.prototype.remove_poll = function (t) {
            return ne(this._running, "update manager is not running"), t in this._handle_version_map ? (delete this._handle_version_map[t], this._do_longpoll()) : void 0
        }, t.prototype._do_longpoll = function () {
            return ne(this._running, "update manager is not running"), this._pending_poll && (this._pending_poll.cancel(), this._pending_poll = null), this._pending_poll = new V(this), this._pending_poll.poll()
        }, t
    }(), H = function () {
        function t(t, e) {
            this.update_manager = t, this.flob_client = e, this.update_manager.run(this._handle_server_update.bind(this)), this._cached_objects = {}, this._dslist_listener = null, this._handle_to_dsid_map = {}
        }
        return t.prototype.destroy = function () {
            ...
            var e;
            if (t in this._cached_objects) return e = this._cached_objects[t].get_handle(), this._cached_objects[t].close();
        ...
        function t(t) {
            var i, o, s, a, l, h, c, p, d, g, m, v = this;
            ...
            for (m = ["P", "D"], a = 0, c = m.length; c > a; a++)
                for (o = m[a], l = 0, p = e.length; p > l; l++) i = e[l], this._transforms[o][i] = f, this._transforms[i][o] = _;
            for (g = 0, d = e.length; d > g; g++) i = e[g], "LC" === i ? this._transforms.LC.LC = function () {
                return [null, null]
        ...
        return l = function (t) {
            ...
            return null == r && (r = null), "sum" === this.rule_name && "P" === t.tag() && "P" === e.tag() && (null == r && (r = {
                I: "0"
            }), d(r) && d(t.value) && d(e.value)) ? (o = a(r, t.value, e.value), n = i = T.from_array(["P", o]), [n, i, e.value]) : (s = this._transforms[t.tag()][e.tag()](t, e), u = function () {
                switch (e.tag()) {
                case "P":
                    return e.value;
                case "D":
        ...
        function t() {
            this._transform_rules = {}, this._default_transformer = new C
        }
        var e, r, i, o, s, a, u, l;
        for (e = {}, l = ["default", "local", "remote", "min", "max", "sum"], a = 0, u = l.length; u > a; a++) i = l[a], e[i] = new C(i);
        return s = function (t) {
            return ne(null != t),
            function (e, r) {
                var n, i, o;
            ...
            return o(t, e) ? (i = function (t) {
                var e, i, o, s, a;
                o = {}, a = t.fields;
                for (i in a) s = a[i], o[i] = T.from_array(["P", r(s)]);
            ...
            var r, i, s, a, u, l, h, c, p, d, f, _, y, g, m, v, w, b, S;
            if (!o(t, e)) return [[t], [e]];
            g = [{}, {}], p = g[0], d = g[1], c = {}, m = t.updates;
            for (s in m) r = m[s], s in e.updates ? (i = e.updates[s], f = null != (w = t.undo_extra[s]) ? w : null, _ = this.get_field_transformer(t.tid, s), b = _.transform(r, i, f), a = b[0], u = b[1], y = b[2], null != a && (p[s] = a, c[s] = null != y ? y : null), null != u && (d[s] = u)) : (p[s] = r, c[s] = null != (v = t.undo_extra[s]) ? v : null);
            S = e.updates;
            for (s in S) i = S[s], s in t.updates || (d[s] = i);
            return l = n.from_array(["U", t.tid, t.rowid, p]), l.undo_extra = c, h = n.from_array(["U", e.tid, e.rowid, d]), [
                [l],
                [h]
            ]
        ...
        return t.prototype.add_resolution_rule = function (t, e, r) {
            ...
            var r, i, o, s, a, u, l, h, c, p, d, f, _, y, g, m, v, w, b, S, D, E, A, x, O, U, T, C, k, I, R, P;
            for (d = [], m = 0, S = t.length; S > m; m++) {
                for (h = t[m], i = [], I = h.changes, p = v = 0, D = I.length; D > v; p = ++v) s = I[p], u = n.from_array(JSON.parse(JSON.stringify(s))), u.undo_extra = ie.clone(h.undo_extras[p]), i.push(u);
                d.push(i)
            }
            for (y = [], w = 0, E = e.length; E > w; w++)
                for (h = e[w], R = h.changes, b = 0, A = R.length; A > b; b++) o = R[b], y.push(o);
            for (P = this._resolve(d, y), f = P[0], l = P[1], _ = [], p = T = 0, x = f.length; x > T; p = ++T) {
                for (a = f[p], g = null, c = t[p].finalized, C = 0, O = a.length; O > C; C++) s = a[C], delete s.undo_extra;
                a.length > 0 && _.push(new z(a, g, c))
            }
            for (r = {}, k = 0, U = l.length; U > k; k++) o = l[k], o.tid in r || (r[o.tid] = {}), r[o.tid][o.rowid] = !0;
            return {
                rebased_deltas: _,
                affected_records: r
            }
        ...
        function t(t) {
            this.consumer = t, this.items = [], this.sync_queue = new Q
        }
        ...
        if (t instanceof Array) {
            for (a = [], o = 0, s = t.length; s > o; o++) e = t[o], a.push(ie.clone(e));
            return a
        }
        if (null != t && "object" == typeof t) {
            n = {};
            for (r in t) i = t[r], n[r] = ie.clone(i);
            return n
        }
        return t
        ...
        return function () {
            var r, n;
            for (n = [], e = r = 0; t >= 0 ? t > r : r > t; e = t >= 0 ? ++r : --r) n.push(ie.randomElement(ie.WEB64_ALPHABET));
            return n
        }().join("")
        ...
        return n = x.Util.btoa(r), ie.dbase64FromBase64(n)
        ...
        if (te.is_array(t)) {
            if (e) return function () {
                var e, r, i;
                for (i = [], e = 0, r = t.length; r > e; e++) n = t[e], i.push(ie.toDsValue(n, !1));
                return i
            }();
        ...
        n = function (t, e) {
            ...
            if (te.is_bool(t) && te.is_bool(e)) return "object" == typeof t && (t = t.valueOf()), "object" == typeof e && (e = e.valueOf()), Boolean(t) === Boolean(e);
            if (te.is_number(t) && (te.is_number(e) || null != e.N || null != e.I)) return e = ie.fromDsValue(void 0, void 0, void 0, e), t[ie.INT64_TAG] && e[ie.INT64_TAG] ? (s = [x.Datastore.int64(t), x.Datastore.int64(e)], t = s[0], e = s[1], String(t[ie.INT64_TAG]) === String(e[ie.INT64_TAG])) : isNaN(t) && isNaN(e) ? !0 : Number(t) === Number(e);
            ...
            if (te.is_date(t) && (te.is_date(e) || null != e.T)) return null != e.T && (e = ie.fromDsValue(void 0, void 0, void 0, e)), t - 0 === e - 0;
        ...
        return t.prototype.get = function (t, e) {
            ...
            var r;
            return null == this._cache[t] && (this._cache[t] = {}), r = this._cache[t][e], null == r && (r = this._cache[t][e] = new x.Datastore.Record(this._datastore, t, e)), r
        }, t.prototype.remove = function (t, e) {
            return delete this._cache[t][e], te.is_empty(this._cache[t]) && delete this._cache[t], void 0
        }, t
    }(), O = function () {
        function t() {
        ...
        return t.prototype.register = function (t, e) {
            ...
            var t, e, r, n, i, o;
            for (i = this._registered_handlers, r = 0, n = i.length; n > r; r++) o = i[r], e = o[0], t = o[1], e.removeListener(t);
            return void 0
        }, t
        ...
        function e(t) {
            this.options = t, e.__super__.constructor.call(this, t), this._have_event = !1, this._last_event = null, this._listenersChanged = new x.Util.EventSource
        }
        return ue(e, t), e.prototype._clearLastEvent = function () {
        ...
        function t(t) {
            ...
            this._flob_client = new k(t), this._datasync = new h(this._flob_client), this._dslist_initialized = !1, this.datastoreListChanged = new x.Datastore.impl.EventSourceWithInitialData, this.datastoreListChanged._listenersChanged.addListener(function (t) {
        ...
        return t.prototype.datastoreListChanged = null, t.prototype.close = function () {
            ...
            if (null != t.info) {
                e = {}, o = t.info;
                for (r in o) i = o[r], e[r] = te.is_array(i) ? function () {
                    var t, e, r;
                    for (r = [], t = 0, e = i.length; e > t; t++) n = i[t], r.push(ie.fromDsValue(null, null, null, n));
                    return r
            ...
            return function () {
                var r, n, i, o;
                for (i = t.datastores, o = [], r = 0, n = i.length; n > r; r++) e = i[r], o.push(this._datastoreInfoFromListDatastoresResponseItem(e));
                return o
            }.call(this)
            ...
            return e && (t._update_mtime(), t.sync()), new x.Datastore(this, t)
            ...
            var e, r;
            return r = ie.randomWeb64String(Math.ceil(256 / 6)), e = "." + ie.dbase64FromBase64(x.Util.sha256(r)), this._createDatastore(e, r, t), void 0
        ...
        return t.prototype.toString = function () {
            ...
            var e;
            return this._checkValid(), e = ie.clone(this._array()[this._fixIndex(t)]), ie.fromDsValue(void 0, void 0, void 0, e)
        }, t.prototype.set = function (t, e) {
            return this._checkValid(), t = this._fixIndex(t), this._storeUpdate(["LP", t, ie.toDsValue(e, !1)]), void 0
            ...
            var t, e, r, n, i, o, s, a, u;
            if (n = arguments[0], e = arguments[1], t = 3 <= arguments.length ? le.call(arguments, 2) : [], this._checkValid(), !te.is_json_number(e) || 0 > e) throw new RangeError("Bad second arg to splice: " + n + ", " + e);
            ...
            return this._checkValid(), t = this._fixInsertionIndex(t), this._storeUpdate(["LI", t, ie.toDsValue(e, !1)]), void 0
        }, t.prototype.slice = function (t, e) {
            var r;
            return this._checkValid(),
            function () {
                var n, i, o, s;
                for (o = this._array().slice(t, e), s = [], n = 0, i = o.length; i > n; n++) r = o[n], s.push(ie.fromDsValue(void 0, void 0, void 0, r));
                return s
            }.call(this)
            ...
            function () {
                var e, r, n, i;
                for (n = this._array().slice(), i = [], e = 0, r = n.length; r > e; e++) t = n[e], i.push(ie.fromDsValue(void 0, void 0, void 0, t));
                return i
            }.call(this)
        }, t
        ...
        return t.prototype.get = function (t) {
            var e;
            return this._checkNotDeleted(), e = this._rawFieldValues(), t in e ? ie.fromDsValue(this._datastore, this, t, e[t]) : null
        }, t.prototype.set = function (t, e) {
            var r;
            return r = {}, r[t] = e, this.update(r)
        }, t.prototype.getOrCreateList = function (t) {
            var e, r;
            if (this._checkNotDeleted(), r = this._rawFieldValues(), null == r[t]) e = {}, e[t] = ["LC"], this._storeUpdate(e), r = this._rawFieldValues();
            ...
            for (e in n) r = n[e], t[e] = ie.fromDsValue(this._datastore, this, e, r);
            return t
        }, t.prototype.update = function (t) {
            var e, r, n;
            this._checkNotDeleted(), e = {};
            for (r in t) n = t[r], null != n ? e[r] = ["P", ie.toDsValue(n)] : null != this.get(r) && (e[r] = ["D"]);
            return te.is_empty(e) || this._storeUpdate(e), this
        }, t.prototype.deleteRecord = function () {
            var t;
            return this._checkNotDeleted(), this._deleted = !0, this._record_cache.remove(this._tid, this._rid), t = h.changeFromArray(["D", this._tid, this._rid]), this._managed_datastore.perform_local_change(t), this._datastore._recordsChangedLocally([this]), this
        }, t.prototype.has = function (t) {
            var e;
            ...
            var e;
            e = h.changeFromArray(["U", this._tid, this._rid, t]), this._managed_datastore.perform_local_change(e), this._datastore._recordsChangedLocally([this])
        }, t.isValidId = function (t) {
            var e;
            return e = new RegExp(te.SS_ID_REGEX), te.is_string(t) && e.test(t)
        ...
        return t.prototype.getId = function () {
            ...
            return r = this._record_cache.get(this._tid, t), null != r ? (ne(!r._deleted), r) : (e = this._managed_datastore.query(this._tid, t), null == e ? null : this._record_cache.getOrCreate(this._tid, t))
        }, t.prototype.getOrInsert = function (t, e) {
            var r;
            return r = this.get(t), r ? r : this._insertWithId(t, e)
        }, t.prototype.insert = function (t) {
            var e;
            return e = this._datastore._generateRid(), ne(null == this.get(e)), this._insertWithId(e, t)
        }, t.prototype.query = function (t) {
            var e, r, n, i, o, s, a;
            for (o = this._managed_datastore.list_rows_for_table(this._tid), n = [], s = 0, a = o.length; a > s; s++) i = o[s], e = this._managed_datastore.query(this._tid, i), (null == t || ie.matchDsValues(t, e)) && (r = this.get(i), ne(null != r), n.push(r));
            return n
            ...
            var r, n, i, o, s;
            n = {};
            for (i in e) s = e[i], n[i] = ie.toDsValue(s);
            return r = h.changeFromArray(["I", this._tid, t, n]), this._managed_datastore.perform_local_change(r), o = this._record_cache.getOrCreate(this._tid, t), this._datastore._recordsChangedLocally([o]), o
        }, t
    }(), x.File.ShareUrl = function () {
        function t(t, e) {
            this.url = t.url, this.expiresAt = x.Util.parseDate(t.expires), this.isDirect = e === !0 ? !0 : e === !1 ? !1 : "direct" in t ? t.direct : Date.now() - this.expiresAt <= 864e5, this.isPreview = !this.isDirect, this._json = null
        }
        ...
        function t(t) {
            "object" == typeof t ? (this.tag = t.copy_ref, this.expiresAt = x.Util.parseDate(t.expires), this._json = t) : (this.tag = t, this.expiresAt = new Date(1e3 * Math.ceil(Date.now() / 1e3)), this._json = null)
        }
        return t.parse = function (t) {
        ...
        function t(t) {
            ...
            this.blankSlate = t.reset || !1, this.cursorTag = t.cursor, this.shouldPullAgain = t.has_more, this.shouldBackOff = !this.shouldPullAgain, this.changes = t.cursor && t.cursor.length ? function () {
                var r, n, i, o;
                for (i = t.entries, o = [], r = 0, n = i.length; n > r; r++) e = i[r], o.push(x.Http.PulledChange.parse(e));
                return o
            }() : []
        }
        return t.parse = function (t) {
        ...
        function t(t) {
            this.path = t[0], this.stat = x.File.Stat.parse(t[1]), this.stat ? this.wasRemoved = !1 : (this.stat = null, this.wasRemoved = !0)
        }
        return t.parse = function (t) {
        ...
        return t.parse = function (t) {
            ...
            return "object" == typeof t ? (this.tag = t.upload_id || null, this.offset = t.offset || 0, this.expiresAt = x.Util.parseDate(t.expires) || Date.now(), this._json = t) : (this.tag = t || null, this.offset = 0, this.expiresAt = new Date(1e3 * Math.floor(Date.now() / 1e3)), this._json = null), this
        }, t
        ...
        return e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = function (t, r, n) {
            var i, o;
            for (o = 3 - r, t <<= 8 * o, i = 3; i >= o;) n.push(e.charAt(63 & t >> 6 * i)), i -= 1;
            for (i = r; 3 > i;) n.push("="), i += 1;
            return null
        }, t = function (t, e, r) {
            var n, i;
            ...
            var e, n, i, o, s, a;
            for (o = [], e = 0, n = 0, i = s = 0, a = t.length; a >= 0 ? a > s : s > a; i = a >= 0 ? ++s : --s) e = e << 8 | t.charCodeAt(i), n += 1, 3 === n && (r(e, n, o), e = n = 0);
            return n > 0 && r(e, n, o), o.join("")
        }, x.Util.atob = function (r) {
            var n, i, o, s, a, u, l;
            for (a = [], n = 0, o = 0, s = u = 0, l = r.length;
                (l >= 0 ? l > u : u > l) && (i = r.charAt(s), "=" !== i); s = l >= 0 ? ++u : --u) n = n << 6 | e.indexOf(i), o += 1, 4 === o && (t(n, o, a), n = o = 0);
        ...
        if (x.Util.hmac = function (e, n) {
            ...
            e = x.Env.require("crypto"), e.createHmac && e.createHash && (x.Util.hmac = function (t, r) {
                var n;
        ...
        return r = function (t, e, r, n) {
            ...
            return e.length > 16 && (e = i(e, n)), a = function () {
                var t, r;
                for (r = [], s = t = 0; 16 > t; s = ++t) r.push(909522486 ^ e[s]);
                return r
            }(), u = function () {
                var t, r;
                for (r = [], s = t = 0; 16 > t; s = ++t) r.push(1549556828 ^ e[s]);
                return r
            }(), o = i(a.concat(t), 64 + r), i(u.concat(o), 84)
        }, i = function (t, e) {
            var r, n, i, o, s, a, u, l, h, c, p, d, f, _, y, g, m;
            for (t[e >> 2] |= 1 << 31 - ((3 & e) << 3), t[(e + 8 >> 6 << 4) + 15] = e << 3, y = Array(80), r = 1732584193, i = 4023233417, s = 2562383102, u = 271733878, h = 3285377520, p = 0, f = t.length; f > p;) {
                for (n = r, o = i, a = s, l = u, c = h, d = m = 0; 80 > m; d = ++m) 16 > d ? y[d] = 0 | t[p + d << 2 >> 2] : (_ = (0 | y[d - 3 << 2 >> 2]) ^ (0 | y[d - 8 << 2 >> 2]) ^ (0 | y[d - 14 << 2 >> 2]) ^ (0 | y[d - 16 << 2 >> 2]), y[d] = _ << 1 | _ >>> 31), g = 0 | (0 | (r << 5 | r >>> 27) + h) + y[d << 2 >> 2], g = 20 > d ? 0 | g + (0 | (i & s | ~i & u) + 1518500249) : 40 > d ? 0 | g + (0 | (i ^ s ^ u) + 1859775393) : 60 > d ? 0 | (0 | g + ((i & s | i & u | s & u) - 1894007588)) : 0 | g + (0 | (i ^ s ^ u) - 899497514), h = u, u = s, s = i << 30 | i >>> 2, i = r, r = g;
                r = 0 | n + r, i = 0 | o + i, s = 0 | a + s, u = 0 | l + u, h = 0 | c + h, p = 0 | p + 16
            }
            return [r, i, s, u, h]
        }, o = function (t, e) {
            var r, n, i, o, u, l, h, c, p, d, f, _, y, g, m, v, w, b, S, D, E, A, x, O, U, T, C, k, I, R, P, L;
            for (t[e >> 2] |= 1 << 31 - ((3 & e) << 3), t[(e + 8 >> 6 << 4) + 15] = e << 3, I = Array(80), r = s[0], i = s[1], u = s[2], c = s[3], d = s[4], _ = s[5], g = s[6], D = s[7], A = 0, O = t.length; O > A;) {
                for (n = r, o = i, l = u, p = c, f = d, y = _, m = g, E = D, x = L = 0; 64 > L; x = ++L) 16 > x ? k = I[x] = 0 | t[A + x << 2 >> 2] : (w = 0 | I[x - 15 << 2 >> 2], v = (w << 25 | w >>> 7) ^ (w << 14 | w >>> 18) ^ w >>> 3, S = 0 | I[x - 2 << 2 >> 2], b = (S << 15 | S >>> 17) ^ (S << 13 | S >>> 19) ^ S >>> 10, k = I[x] = 0 | (0 | v + (0 | I[x - 7 << 2 >> 2])) + (0 | b + (0 | I[x - 16 << 2 >> 2]))), h = d & _ ^ ~d & g, U = r & i ^ r & u ^ i & u, T = (r << 30 | r >>> 2) ^ (r << 19 | r >>> 13) ^ (r << 10 | r >>> 22), C = (d << 26 | d >>> 6) ^ (d << 21 | d >>> 11) ^ (d << 7 | d >>> 25), R = 0 | (0 | (0 | D + C) + (0 | h + k)) + (0 | a[x << 2 >> 2]), P = 0 | T + U, D = g, g = _, _ = d, d = 0 | c + R, c = u, u = i, i = r, r = 0 | R + P;
                r = 0 | n + r, i = 0 | o + i, u = 0 | l + u, c = 0 | p + c, d = 0 | f + d, _ = 0 | y + _, g = 0 | m + g, D = 0 | E + D, A += 16
            }
            return [r, i, u, c, d, _, g, D]
        }, l = function (t) {
        ...
        function () {
            ...
            var e, r, n, i, o;
            for (i = "", e = 0, n = 4 * t.length; n > e;) r = e, o = (255 & t[r >> 2] >> (3 - (3 & r) << 3)) << 16, r += 1, o |= (255 & t[r >> 2] >> (3 - (3 & r) << 3)) << 8, r += 1, o |= 255 & t[r >> 2] >> (3 - (3 & r) << 3), i += h[63 & o >> 18], i += h[63 & o >> 12], e += 1, i += e >= n ? "=" : h[63 & o >> 6], e += 1, i += e >= n ? "=" : h[63 & o], e += 1;
            return i
        ...
        return t.prototype.setCredentials = function (t) {
            ...
            if (t.error) {
                ...
                return this.reset(), this._error = new x.AuthError(t), !0
            }
            if (t.code) {
            ...
            for (a = i[2] || "", "/" === a.substring(0, 1) && (a = a.substring(1)), e = i[4] || "", r = e.indexOf("?"), -1 !== r && (e = e.substring(r + 1)), "/" === e.substring(0, 1) && (e = e.substring(1)), s = {}, h = a.split("&").concat(e.split("&")), u = 0, l = h.length; l > u; u++) n = h[u], o = n.indexOf("="), -1 !== o && (s[decodeURIComponent(n.substring(0, o))] = decodeURIComponent(n.substring(o + 1)));
            return s
            ...
            }, i = t.toUpperCase() + "&" + x.Util.Xhr.urlEncodeValue(e) + "&" + x.Util.Xhr.urlEncodeValue(x.Util.Xhr.urlEncode(r)), n.mac = x.Util.hmac(i, this._tokenKey), n
        }, t.prototype.appHash = function () {
    ...
    }), 2274814865e3 === new Date("Fri, 31 Jan 2042 21:01:05 +0000").valueOf() ? x.Util.parseDate = function (t) {
        return new Date(t)
    } : 2274814865e3 === Date.parse("Fri, 31 Jan 2042 21:01:05 +0000") ? x.Util.parseDate = function (t) {
        ...
        var e, r, n, i, o;
        for (e = 0, n = i = 0, o = t.length; o >= 0 ? o > i : i > o; n = o >= 0 ? ++i : --i) r = t.charCodeAt(n), 127 >= r ? e += 1 : 2047 >= r ? e += 2 : r >= 55296 && 57343 >= r ? e += 2 : 65535 >= r ? e += 3 : ne(!1);
        return e
    }, x.Env.global.XMLHttpRequest ? (!x.Env.global.XDomainRequest || "withCredentials" in new XMLHttpRequest ? (w = XMLHttpRequest, v = !1, g = "undefined" != typeof FormData && -1 === navigator.userAgent.indexOf("Firefox")) : (w = XDomainRequest, v = !0, g = !1), m = !0) : (w = x.Env.require("xhr2"), v = !1, g = !1, m = !1), x.Env.global.Uint8Array)
        if (Object.getPrototypeOf ? y = Object.getPrototypeOf(Object.getPrototypeOf(new Uint8Array(0))).constructor : Object.__proto__ && (y = new Uint8Array(0).__proto__.__proto__.constructor), x.Env.global.Blob) {
            try {
                ...
                b = !1, S = !1, x.Env.global.WebKitBlobBuilder && -1 !== navigator.userAgent.indexOf("Android") && (g = !1)
            }
            y === Object && (b = !1)
        } else S = !1, b = !0;
        else y = null, S = !1, b = !1;
    x.Util.Xhr = function () {
        ...
        return t.Request = w, t.ieXdr = v, t.canSendForms = g, t.doesPreflight = m, t.ArrayBufferView = y, t.sendArrayBufferView = b, t.wrapBlob = S, t.prototype.xhr = null, t.prototype.onError = null, t.prototype.setParams = function (t) {
            ...
            if ("object" == typeof r) {
                "undefined" != typeof ArrayBuffer && (r instanceof ArrayBuffer ? x.Util.Xhr.sendArrayBufferView && (r = new Uint8Array(r)) : !x.Util.Xhr.sendArrayBufferView && 0 === r.byteOffset && r.buffer instanceof ArrayBuffer && (r = r.buffer)), n || (n = "application/octet-stream");
                try {
                    r = new Blob([r], {
                        type: n
                    })
            ...
            var t;
            return this.params && (t = x.Util.Xhr.urlEncode(this.params), 0 !== t.length && (this.url = [this.url, "?", t].join("")), this.params = null), this
        }, t.prototype.paramsToBody = function () {
            if (this.params) {
                if (null !== this.body) throw new Error("Request already has a body");
                if (this.isGet) throw new Error("paramsToBody cannot be called on GET requests");
                this.headers["Content-Type"] = "application/x-www-form-urlencoded", this.body = x.Util.Xhr.urlEncode(this.params), this.params = null
            }
            return this
            ...
            if (this.callback = t || this.callback, null !== this.body) {
                e = this.body, x.Util.Xhr.sendArrayBufferView ? e instanceof ArrayBuffer && (e = new Uint8Array(e)) : 0 === e.byteOffset && e.buffer instanceof ArrayBuffer && (e = e.buffer);
                try {
                    this.xhr.send(e)
                } catch (n) {
            ...
            if (this.completed = !0, this.xhr.status < 200 || this.xhr.status >= 300) return e = new x.ApiError(this.xhr, this.method, this.url), this.onError ? this.onError(e, this.callback) : this.callback(e), !0;
            ...
            if (this.responseType) {
                if ("b" === this.responseType) {
                    for (i = null != this.xhr.responseText ? this.xhr.responseText : this.xhr.response, r = [], a = d = 0, f = i.length; f >= 0 ? f > d : d > f; a = f >= 0 ? ++d : --d) r.push(String.fromCharCode(255 & i.charCodeAt(a)));
                    p = r.join(""), this.callback(null, p, l, s)
    ...
    }(), re = "X-Dropbox-User-Agent", J = "X-Dropbox-Request-Id", x.DatastoresClient = {
        _dispatchDatastoreXhr: function (t, e, r, n, i, o) {
            var s, a, l;
            return l = new x.Util.Xhr(t, e), i.setRequestId && (a = "xxxxxxxxxxxxxxxx".replace(/x/g, function () {
                return Math.floor(16 * Math.random()).toString(16)
            }), l.setHeader(J, a)), ne(null == r[re]), r = ie.clone(r), r[re] = "dropbox-js-datastore-sdk/" + u, l.setParams(r), l.signWithOauth(this.oauth, !1), s = function (t, e) {
                var r;
                ...
                if (te.is_string(e)) {
                    ...
                    try {
                        ...
                        r = i, console.log("Error parsing response as JSON", r.stack)
                    }
                }
                return o(null, n.fromJSON(e))
            }, i.isLongPoll ? this.dispatchLongPollXhr(l, s) : this.dispatchXhr(l, s), l
        },
        _listDatastores: function (t) {
            return this._dispatchDatastoreXhr("GET", this.urls.listDbs, {}, N, {}, t)
        },
    ...
    function () {
        var t, e, r, n;
        r = x.DatastoresClient, n = [];
        for (e in r) t = r[e], n.push(x.Client.prototype[e] = t);
        return n
    }(), x.File.PublicUrl = x.File.ShareUrl, x.UserInfo = x.AccountInfo
}.call(this);